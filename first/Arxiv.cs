...
namespace first
{
    class Arxiv
    {
        public List<Person> personsinArxiv;
        public Arxiv(List<Person> person)
        {
            personsinArxiv = person;
        }
        public void readPersonsListFromFile()
        {
            personsinArxiv = new List<Person>();
        ...
        public void savePersonsListInFile()
        {
            ...
            xDoc.Load(@"..\..\Arxiv.xml");
            XmlElement xRoot = xDoc.DocumentElement;
            foreach (Person person in personsinArxiv)
            {
